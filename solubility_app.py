...
st.write(""" Please ** keep the column names in the CSV File ** as follows : 'MolLogP' ,  'NumRotatableBonds' , 'AromaticProportion' , 'MolWt' """)
...
if uploaded_file is not None:
    ...
    st.write(res)
logger.info("App Successfully Executed !!!")